...
public class Intent {
	static final String START_INTENT = "com.sciaps.alogcat.intent.START";
	static final String SAVE_INTENT = "com.sciaps.alogcat.intent.SAVE";
	static final String SHARE_INTENT = "com.sciaps.alogcat.intent.SHARE";
